                    ...
                    <table>
                        <tr>
                            <td>
                                ...
                                <h4> {{$request['nombre']}} quiere comunicarse con nosotros.</h4>
                                ...
                                <p class="callout">
                                    ...
                                    Email: {{$request['email']}}
                                    <br>
                                    Teléfono: {{$request['email']}}
                                    <br>
                                    Empresa: {{$request['telefono']}}
                                    <br>
                                    Mensaje: {{$request['empresa']}}
                                    <br>
                                    Estoy interesado/a en:
                                    <br>
                                    @foreach ($request['interesado'] as $item)
                                        <ul>
                                            <li>{{ $item }}</li>
                                        </ul>
                                    @endforeach
