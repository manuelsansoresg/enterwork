    ...
    <div class="container">
                ...
                <div class="sala-juntas__box__content">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12 col-md-8 text-center">
                            <p class="description">
                                Nuestas salas de juntas son completamente adaptables a tus necesidades, desde el número de personas hasta el equipo electrónico y materiales que necesites, coffee break para juntas largas o catering para desayunos. Nuestro staff te ayudará en todo lo que necesites para que sólo tengas que preocuparte de tu presentación.
                            </p>
                        </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="row mt-5 justify-content-center">
                                <div class="col-6 col-md-3 text-center">
                                    ...
                                    <p class="sala-juntas__description mt-4" data-aos="fade-up" data-aos-duration="1500">Paneles para espacio  flexible</p>
                                </div>
                                <div class="col-6 col-md-3 text-center">
                                    <img class="sala-juntas__icons" src="/img/sala_juntas/Pantallas.svg" alt="">
                                    <p class="sala-juntas__description mt-4" data-aos="fade-up" data-aos-duration="1500">Pantallas interactivas </p>
                                </div>
                                <div class="col-6 col-md-3 text-center">
                                    <img class="sala-juntas__icons" src="/img/sala_juntas/Cafe_1.svg" alt="">
                                    <p class="sala-juntas__description mt-4" data-aos="fade-up" data-aos-duration="1500">Servicio de café y bebidas</p>
                                </div>
                                <div class="col-6 col-md-3 text-center">
                                    <img class="sala-juntas__icons" src="/img/sala_juntas/wifi.svg" alt="">
                                    <p class="sala-juntas__description mt-4" data-aos="fade-up" data-aos-duration="1500">Internet WiFi y Ethernet dedicado</p>
                                </div>
                                <div class="d-none d-md-block w-100 mt-4"></div>
                                <div class="col-6 col-md-3 text-center">
                                    <img class="sala-juntas__icons" src="/img/sala_juntas/Recepcion.svg" alt="">
                                    <p class="sala-juntas__description mt-4" data-aos="fade-up" data-aos-duration="1500">Recepción y staff de apoyo </p>
                                </div>
                                <div class="col-6 col-md-3 text-center">
                                    <img class="sala-juntas__icons" src="/img/sala_juntas/Limpieza_1.svg" alt="">
                                    <p class="sala-juntas__description mt-4" data-aos="fade-up" data-aos-duration="1500">Servicio de Limpieza </p>
                                </div>
                                <div class="col-6 col-md-3 text-center">
                                    <img class="sala-juntas__icons" src="/img/sala_juntas/Estacionamiento.svg" alt="">
                                    <p class="sala-juntas__description mt-4" data-aos="fade-up" data-aos-duration="1500">Estacionamiento</p>
                                </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="row mt-5">
                    <div class="col-md-6 ">
                        <p class="description" data-aos="fade-left" data-aos-duration="1500">
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-md-6 object-bold" data-aos="fade-right" data-aos-duration="1500">
                                <p class="my-0 d-none">+52 (998) 154 3834 </p>
                                <p>hola@enterwork.mx  </p>
                            </div>
                            <div class="col-md-6 text-center text-md-right">
                                <a href="/contactanos" class="col-8 col-md-12 col-lg-8 btn btn-pink2 btn-sectionCircle">Reservar</a>
                            </div>
                        </div>
                    </div>
                </div>
